...
{
    public class FbOpenDocumentViewModel
    {
        ...
        public HighlightsViewModel highlights { get; set; }
        ...
        public List<string> HighlightText
        {
            get
            {
                ...
                if (highlights.description.Count > 0)
                {
                    foreach(string s in highlights.description)
                    {
                        retVal.Add( HttpUtility.HtmlDecode(s.Replace("highlight", "span class=\"highlight\"")));
                    }
                }
                return retVal;
            }
