...
Add / Update AgileLizard.Domain object
Add / Update AgileLizard.Data mapping object
If new - add to context in AgileLizard.Data.Entities.cs
...
In the AgileLizard reference, the following is valid for the person service:
HEADERS
User-Agent: Fiddler
